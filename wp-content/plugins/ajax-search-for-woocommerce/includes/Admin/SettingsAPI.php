...
class SettingsAPI {
	...
	function show_navigation() {
        ...
        $html .= '<a target="_blank" href="' . dgoraAsfwFs()->contact_url() . '" class="js-nav-tab-minor nav-tab-minor" >'.__('Contact', 'ajax-search-for-woocommerce').'</a>';

        $html .= '<a target="_blank" href="' . dgoraAsfwFs()->get_account_url() . '" class="js-nav-tab-minor nav-tab-minor" >'.__('Account', 'ajax-search-for-woocommerce').'</a>';
	...
	function script() {
		...
		<script>
		    jQuery( document ).ready( function ( $ ) {
		        ...
		        $( '.<?php echo $this->prefix; ?>nav-tab-wrapper a:not(.js-nav-tab-minor)' ).click( function ( evt ) {
