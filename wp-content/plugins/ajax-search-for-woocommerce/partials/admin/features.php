...
<div class="dgwt-wcas-upgrade-s">
    ...
    <ul>
        <li><strong>+ <?php _e('Speed up search! (even 10x faster) - users love it!', 'ajax-search-for-woocommerce'); ?></strong></li>
        <li><strong>+ <?php _e('Efficient with a large number of products. Tested on 20 000 products', 'ajax-search-for-woocommerce'); ?></strong></li>
